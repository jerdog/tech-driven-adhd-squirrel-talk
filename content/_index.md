...
![i want to be where the people are....](/images/where-the-people-are.gif)
{.r-stretch}
...
<section>
    <div class="multiCol">
        <div class="col">
            ...
            <figcaption style="font-size: .40em;font-style: italic;">Image: Kaypro II, Wikipedia Commons</figcaption>
        </div>
        <div class="col">
            <h4 style="color: rgb(111, 168, 220);">Kaypro II</h4>
            <ul>
                <li style="font-size: .75em;">2.5 MHz Zilog Z80 CPU
                <li style="font-size: .75em;">64KB RAM
                <li style="font-size: .75em;">2 single-sided 180KB 5¼-inch floppies
                <li style="font-size: .75em;">80-column, green monochrome 9" CRT
            </ul>
        </div>
    </div>
</section>
...
<section>
    <div class="multiCol">
        <div class="col">
            ...
            <figcaption style="font-size: .40em;font-style: italic;">Image: Computing History Org, UK</figcaption>
        </div>
        <div class="col">
            <h4 style="color: rgb(111, 168, 220);font-size: 1em">Compaq Portable Plus</h4>
            <ul>
                <li style="font-size: .75em;">4.7 MHz 8088 CPU
                <li style="font-size: .75em;">128KB RAM
                <li style="font-size: .75em;">1 double-sided 360KB 5¼-inch floppy
                <li style="font-size: .75em;">10MB MFM hard drive
                <li style="font-size: .75em;">9" green monochrome CRT
                <li style="font-size: .75em;">DOS 2.0
                <li style="font-size: .75em;">Keyboard attaches to the top
                <li style="font-size: .75em;">Weight: 28 pounds
            </ul>
        </div>
    </div>
</section>
...
<section>
    <div class="multiCol">
        <div class="col">
            ...
            <figcaption style="font-size: .40em;font-style: italic;">Image: IBM PC XT, Wikimedia</figcaption>
        </div>
        <div class="col">
            <h4 style="color: rgb(111, 168, 220);font-size: 1em">IBM PC XT</h4>
            <ul>
                <li style="font-size: .75em;">4.7 MHz Intel 8088 CPU
                <li style="font-size: .75em;">128KB-640KB RAM
                <li style="font-size: .75em;">1 double-sided 360KB 5¼-inch floppy
                <li style="font-size: .75em;">10-20MB MFM/RLL hard drive
                <li style="font-size: .75em;">MDA / CGA graphics
                <li style="font-size: .75em;">DOS 2.0-3.20, various others
                <li style="font-size: .75em;">External peripheral connectivity
                <li style="font-size: .75em;">PC speaker, 1-channel sound
                <li style="font-size: .75em;">Weight: 32 pounds
            </ul>
        </div>
    </div>
</section>
...
![Jeremy done fucked up his computer](/images/matrix-dying-640px.gif)
{.r-stretch}
...
![Jeremy's sorry and you're welcome](/images/im-sorry-youre-welcome.jpeg)
{.r-stretch}
...
<p class="fragment" style="font-size: .75em;">Urologist</p>
<p class="fragment" style="font-size: .75em;">Neurologist</p>
<p class="fragment" style="font-size: .75em;">Neuropsychologist</p>
<p class="fragment" style="font-size: .75em;">Gastroenterologist</p>
<p class="fragment" style="font-size: .75em;">Hematologist</p>
<p class="fragment" style="font-size: .75em;">Oncologist</p>
<p class="fragment" style="font-size: .75em;">Geologist</p>
...
<!-- 
{{% tweet user="IAmJerdog" id="1486754532214378503" %}}
-->

![Just calm down](https://media4.giphy.com/media/2z5Hning0WRomUXbbM/giphy.gif)
{.r-stretch}
...
![ADHD bingo card](/images/adhd-bingo.jpeg)
{.r-stretch}
...
![ADHD - ONE OF US!](/images/adhd-one-of-us.gif)
{.r-stretch}
...
![Alt text](/images/adhd-vulnerable.jpg)
{.r-stretch}
...
![Alt text](/images/adhd-vulnerable2.jpg)
{.r-stretch}
...
![StackOverflow - ADHD](/images/adhd-stackoverflow.jpg)
{.r-stretch}
...
![ADHD podcast](/images/adhd-podcast.jpg)
{.r-stretch}
...
{{% tweet user="IAmJerdog" id="1711471142127435908" %}}
...
{{% tweet user="DevOpsBarbie" id="1711628918384365762" %}}
{.r-stretch}
...
{{% tweet user="_KaylaSween" id="1711752796502958090" %}}
...
{{% tweet user="elchefe" id="1711483281139507516" %}}
...
{{% tweet user="blagh" id="1711773383707250995" %}}
...
{{% tweet user="inkedtater" id="1711478887627346276" %}}
...
{{% tweet user="richburroughs" id="1712533682718912561" %}}
...
{{% tweet user="blagh" id="1711775820660834622" %}}
...
{{% tweet user="cassandrafaris" id="1711750523148202390" %}}
...
{{% tweet user="xirclebox" id="1711475431705075756" %}}
...
{{% tweet user="realjohnkjell" id="1711472750500430108" %}}
...
{{% tweet user="hmfarran" id="1711476711068438550" %}}
